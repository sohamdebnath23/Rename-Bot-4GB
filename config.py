...
DATABASE_URL = os.environ.get("DATABASE_URL"mongodb+srv://bafila8671:K75WZK3nchzkae58@cluster0.zxvqfmi.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"))
